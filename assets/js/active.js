...
if (grids.length > 0) {
    grids.forEach(grid => {
        imagesLoaded(grid, () => {
            ...
            const filtersElem = grid.closest('.lp-container').querySelector('.lp-filter-nav');
...
let lpTooltip = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'))
...
let lpPopover = [].slice.call(document.querySelectorAll('[data-bs-toggle="popover"]'))
